@echo off
REM ============================================
REM Build FTBF Framework for x64 (Intel64)
REM ============================================
...
echo ============================================
echo Building FTBF Framework for x64
echo ============================================
echo.

REM Step 1: Build Rust library
echo [1/4] Building Rust library for x86_64-pc-windows-msvc...
cd /d "%RUST_DIR%"
if errorlevel 1 (
...
copy /Y "%RUST_DIR%\target\x86_64-pc-windows-msvc\release\ftbf_rust.lib" "%RUST_DIR%\target\ftbf_rust.lib"
if errorlevel 1 (
...
echo [3/4] Cleaning obj-intel64 build folder...
cd /d "%FTBF_DIR%"
if exist "obj-intel64" (
    rmdir /s /q "obj-intel64"
...
echo [4/4] Building PIN tool with Visual Studio x64 environment...
...
echo Output: %FTBF_DIR%\obj-intel64\FTBF.dll
echo ============================================
